...
public class MyShareableAdapter extends RecyclerView.Adapter<MyShareableAdapter.MyViewHolder> implements onSwipeListener {

    private static final String TAG = "MyShareableAdapter";
    ...
    public MyShareableAdapter(Context context, List<Task> datas) {
        this.datas = datas;
    ...
    public void onItemDismiss(int position) {
        ...
        user.addTask(currTask.taskID);
        System.err.println(currTask+" was adding");
